    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dependencyInjectionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ResturantAFieldInjection resturantAfieldInjection = new ResturantAFieldInjection();
                resturantAfieldInjection.brewCoffee(DIActivity.this);

                ResturantBFieldInjection resturantBfieldInjection = new ResturantBFieldInjection();
                resturantBfieldInjection.brewCoffee(DIActivity.this);
            }
        });
